...
const MyCourses = () => {
  ...
  return (
    <div className="p-4 max-w-screen-2lg mx-auto">
      <div className="mb-4">
        <h1 className="text-3xl text-gray-800 border-b-2 border-gray-300 pb-2">
          My Courses
        </h1>
      </div>
        ...
        <table className="w-full text-sm text-gray-700">
          <thead className="bg-gray-100">
            <tr className="border-b">
              ...
              <th className="px-4 py-2 border-r text-left font-medium">Status</th>
          ...
          <tbody>
            {filteredCourses.map((course, index) => (
              ...
              >
                ...
                <td className="px-4 py-2">{course.useInOBE ? "Yes" : "No"}</td>
              </tr>
            ))}
          </tbody>
        </table>
